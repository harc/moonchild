...
function createElement(document, desc) {
...
ViewModel.prototype.wrapText = function(start, end, nodeOrDesc) {
  ...
  var node = createElement(doc, nodeOrDesc);
...
module.exports = { TextModel: TextModel, ViewModel: ViewModel, setSelection: setSelection };
