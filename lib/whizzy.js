var whizzy = (function() {
  ...
  Model.prototype.setSelection = function(anchorOffset, cursorOffset) {
    this._anchor = Math.max(0, Math.min(anchorOffset, this._buffer.length));
    this._cursor = Math.max(0, Math.min(cursorOffset, this._buffer.length));
  }
